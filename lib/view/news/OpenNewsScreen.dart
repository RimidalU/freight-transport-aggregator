...
class OpenNewsScreem extends StatefulWidget {
  const OpenNewsScreem({super.key});

  @override
  State<OpenNewsScreem> createState() => _OpenNewsScreemState();
}

class _OpenNewsScreemState extends State<OpenNewsScreem> {
  @override
